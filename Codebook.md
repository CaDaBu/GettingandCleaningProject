...
Here we explain the variables in the file GetandCleanProj.txt. The data description has been taken mostly from <http://archive.ics.uci.edu/ml/datasets/Human+Activity+Recognition+Using+Smartphones>
